...
#define MAX_BACKGROUND_DIMENSION_ARRAY 6 //maksymalna ilosc znakow potrzebna do wczytania linijek z wymiarami
...
extern "C" {
	...
	int getch(void); //gets keyboard
	int getche(void); //gets keyboard and puts it on screen
	int kbhit(void);
	int ungetch(int ch);

	int cputs(const char *str); //puts a text
	int putch(int c); //puts a single char
